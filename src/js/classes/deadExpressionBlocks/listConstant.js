class ListConstantEB extends ExpressionBlock{
    ...
    GetEvalType(){
        ...
        return new ExpressionTypeConstr([elType], ConstrType.Get("list"));
    }

    Duplicate(){
        let copy = new ListConstantEB(this.n, false);
    ...
    AddSlot(){
        let copy = new ListConstantEB(this.n + 1, true);
